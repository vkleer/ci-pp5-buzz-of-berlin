...
/**
 * Renders the EventEditForm component - which is where an Event can be edited.
    ...
    useEffect(() => {
        const handleMount = async () => {
            try {
                ...
                const {title, location_name, date, district, start_time, ticket_price, content, image, is_owner} = data;
